...
{
  nexif::ExifData data;
  nexif::CharData str_neonexif{data.store_string_data("NeonEXIF", 8), 8};
  nexif::CharData str_martijn{data.store_string_data("Martijn Courteaux", 17), 17};
  nexif::CharData str_neonraw{data.store_string_data("NeonRAW", 7), 7};
  nexif::CharData str_silvernode{data.store_string_data("SilverNode", 10), 10};
